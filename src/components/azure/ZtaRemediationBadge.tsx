...
const ztaRemediationBadgeButtonClassName = `cursor-pointer rounded-full ${ztaRemediationBadgeTypographyClassName} transition-opacity hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring`;
